...
if __name__ == "__main__":
    ...
    # Load your data
    filepath = root + "data-analysis/non_russian_df_full_traj.pkl"
    df = pd.read_pickle(filepath)

    # Build argument list
    args_list = [
        (row["traj_window"], row["tp_traj_window_legalised"])
    ...
    root = "/raoscratch/home/phschnei/projects/io-detection-reddit/"
    # Save your data
    filepath = root + "data-analysis/non_russian_df_w_gail_opt.pkl"
