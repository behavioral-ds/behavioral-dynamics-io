...
def parse_args():
    ...
    p.add_argument("--use_running_norm", action="store_true")
...
if __name__ == "__main__":
    ...
    # Top 5 runs & zero perturbation
    df = df_raw[(df_raw['run'].isin(range(5))) & (df_raw["perturb_percent"] == 0)]
    ...
    root = "/raoscratch/home/phschnei/projects/io-detection-reddit/"
    # Load your data
    rn = "rn1" if args.use_running_norm else "rn0"
    base = f"gail_g{args.gamma}_n{args.nodes}_s{args.steps}_{rn}"
    out_path = root + f"data-analysis/sampled_matched_perturbed_df_{base}.pkl"
